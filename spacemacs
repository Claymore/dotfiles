...
values."
  (setq-default
   ...
   '(
     ...
     yaml
     (shell :variables
            shell-default-term-shell "~/.homebrew/bin/zsh"
   ...
   dotspacemacs-additional-packages '(flycheck-google-cpplint)
...
layers configuration. You are free to put any user code."
  ...
  (eval-after-load "git-link"
    '(progn
       (add-to-list 'git-link-remote-alist
                    '("git.lanbilling.ru" git-link-gitlab))
       (add-to-list 'git-link-commit-remote-alist
                    '("git.lanbilling.ru" git-link-github))))
  ...
  (with-eval-after-load 'org
    ...
    (setq-default
     ...
     org-todo-keywords
      '((sequence "TODO(t)" "IN-PROGRESS(p!)" "ON-HOLD(h!)" "WAITING(w!)" "|" "DONE(d!)" "CANCELED(c@/!)"))
     org-directory "~/projects/git.bobyakov.org/org"
     org-default-notes-file "~/projects/git.bobyakov.org/org/refile.org"
     org-agenda-files '("~/projects/git.bobyakov.org/org")
     ...
     org-capture-templates
      '(("t" "A new task" entry (file+headline "refile.org" "Tasks")
         "* TODO %?
SCHEDULED: %t")
        ("n" "A new note" entry (file+headline "refile.org" "Notes")
         "* %? :note:
:LOGBOOK:
- Added at %U
:END:")
